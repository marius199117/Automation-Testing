...
public class SignUpPage extends Helper2{
    ...
    public void successfulSignUp(UserInfo userInfo) {
        ...
        sendKeys(this.getDriver(), usernameField(), userInfo.username,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.password,2000);
    ...
    public void specialCharactersSignUp(UserInfo userInfo) {
        clickElement(this.getDriver(), signUp(),2000);
        Assert.assertTrue("Sign Up is not functional", signUp.isDisplayed());
        sendKeys(this.getDriver(), usernameField(), userInfo.usernameSpecialCharacters,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.passwordSpecialCharacters,2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
    ...
    public void digitsSignUp(UserInfo userInfo) {
        clickElement(this.getDriver(), signUp(),2000);
        Assert.assertTrue("Sign Up is not functional", signUp.isDisplayed());
        sendKeys(this.getDriver(), usernameField(), userInfo.usernameDigits,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.passwordDigits,2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
    ...
    public void blankSpaceSignUp() {
        clickElement(this.getDriver(), signUp(),2000);
        sendKeys(this.getDriver(), usernameField(), " ",2000);
        sendKeys(this.getDriver(), passwordField(), " ",2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
    ...
    public void validCredentialsAndBlankSpaceSignUp(UserInfo userInfo) {
        clickElement(this.getDriver(), signUp(),2000);
        Assert.assertTrue("Sign Up is not functional", signUp.isDisplayed());
        sendKeys(this.getDriver(), usernameField(), userInfo.validUsernameBlankSpace,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.validPasswordBlankSpace,2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
    ...
    public void lowercaseCredentials(UserInfo userInfo) {
        ...
        Assert.assertTrue("Sign Up is not functional", signUp.isDisplayed());
        sendKeys(this.getDriver(), usernameField(), userInfo.username,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.passwordLowercaseCredentials,2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
    ...
    public void uppercaseCredentials(UserInfo userInfo) {
        ...
        Assert.assertTrue("Sign Up is not functional", signUp.isDisplayed());
        sendKeys(this.getDriver(), usernameField(), userInfo.username,2000);
        sendKeys(this.getDriver(), passwordField(), userInfo.passwordUppercaseCredentials,2000);
        clickElement(this.getDriver(), signUpButton(),2000);
    }
}
